...
public class RenderUtil implements Util {
    ...
    public static void rectFilled(MatrixStack matrix, float x1, float y1, float x2, float y2, int color) {
        ...
        bufferBuilder.vertex(matrix.peek().getPositionMatrix(), x1, y2, 0.0F).color(red, green, blue, alpha).next();//test
        bufferBuilder.vertex(matrix.peek().getPositionMatrix(), x2, y2, 0.0F).color(red, green, blue, alpha).next();//test
        bufferBuilder.vertex(matrix.peek().getPositionMatrix(), x2, y1, 0.0F).color(red, green, blue, alpha).next();//test
        bufferBuilder.vertex(matrix.peek().getPositionMatrix(), x1, y1, 0.0F).color(red, green, blue, alpha).next();//test
